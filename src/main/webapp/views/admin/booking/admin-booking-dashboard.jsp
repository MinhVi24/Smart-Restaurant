...
<body>
    ...
    <div style="display: flex; min-height: calc(100vh - 72px);">
        <!-- Sidebar -->
        <aside style="width: 250px; background: var(--md-surface-dark); border-right: 1px solid var(--md-border); padding: 24px 0;">
            <div style="padding: 0 20px; margin-bottom: 24px;">
                <p style="font-size: 10px; text-transform: uppercase; letter-spacing: 0.2em; color: var(--md-text-muted); margin-bottom: 16px;">Tổng Quan</p>
                <a href="${pageContext.request.contextPath}/admin/dashboard" style="display: flex; align-items: center; gap: 12px; padding: 12px; border-radius: 8px; color: var(--md-text); text-decoration: none; transition: background 0.2s;">
            ...
            <div style="padding: 0 20px; margin-bottom: 24px;">
                <p style="font-size: 10px; text-transform: uppercase; letter-spacing: 0.2em; color: var(--md-text-muted); margin-bottom: 16px;">Vận Hành</p>
                <a href="${pageContext.request.contextPath}/admin/bookings" style="display: flex; align-items: center; gap: 12px; padding: 12px; border-radius: 8px; background: rgba(212, 175, 53, 0.1); border: 1px solid var(--md-border-gold); color: var(--md-primary); text-decoration: none;">
                    <span class="material-symbols-outlined" style="font-size: 20px;">restaurant</span>
                    <span style="font-size: 13px; font-weight: 600;">Đơn đặt bàn</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/orders" style="display: flex; align-items: center; gap: 12px; padding: 12px; border-radius: 8px; color: var(--md-text); text-decoration: none; transition: background 0.2s; margin-top: 8px;">
                    <span class="material-symbols-outlined" style="font-size: 20px;">receipt_long</span>
                    <span style="font-size: 13px;">Đơn Online</span>
                </a>
                <a href="${pageContext.request.contextPath}/admin/menu" style="display: flex; align-items: center; gap: 12px; padding: 12px; border-radius: 8px; color: var(--md-text); text-decoration: none; transition: background 0.2s; margin-top: 8px;">
                    <span class="material-symbols-outlined" style="font-size: 20px;">menu_book</span>
                    <span style="font-size: 13px;">Thực đơn</span>
                </a>
            </div>
        </aside>
