                        ...
                        <form action="#" class="space-y-6">
                            ...
                            <div class="text-center mt-6">
                                <p class="text-slate-600 dark:text-slate-400 text-sm">
                                    Đã có tài khoản? 
                                    <a href="<%= request.getContextPath()%>/views/customer/auth/login.jsp"
                                       class="text-primary hover:text-primary-light font-semibold hover:underline decoration-primary underline-offset-4 transition-all">
                                        Đăng nhập
                                    </a>                                </p>
                            </div>
                        </form>
