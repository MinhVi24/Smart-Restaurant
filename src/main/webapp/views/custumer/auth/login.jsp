<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Home - RestaurantSmart</title>
                ...
                <div class="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24 overflow-y-auto">
                    <div class="w-full max-w-[440px] flex flex-col gap-8">
                        ...
                        <form action="${pageContext.request.contextPath}/login" method="post"
                            ...
                            <div>
                                <label class="text-sm font-semibold">Phone Number / Username</label>
                                <input name="username" type="text"
                                    ...
                                    placeholder="Enter your phone (+1 555-0000)" required />
                            </div>
                        ...
                        <p class="text-center text-sm text-slate-600">
                            ...
                            <a href="${pageContext.request.contextPath}/views/custumer/auth/register.jsp"
