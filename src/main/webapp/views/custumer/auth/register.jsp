                ...
                <div class="md-card" style="max-width: 600px; width: 100%; padding: 48px;">
                    ...
                    <form action="${pageContext.request.contextPath}/register" method="POST">
                        <div style="margin-bottom: 24px;">
                            ...
                            <input type="text" id="fullname" name="fullname" class="md-input" placeholder="Nguyễn Văn A"
                                required>
                        </div>

                        <div style="margin-bottom: 24px;">
                            <label for="username" class="md-label">Tên đăng nhập</label>
                            <input type="text" id="username" name="username" class="md-input" placeholder="tendangnhap"
                                required>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" class="md-input"
                    ...
                    <div style="position: relative; margin: 32px 0;">
                        ...
                        <div style="position: relative; display: flex; justify-content: center;">
                            <span
                                style="background: var(--md-surface-dark); padding: 0 16px; color: var(--md-text-muted); font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.1em;">Hoặc</span>
                        </div>
                    </div>
