                    ...
                    <div class="max-w-md w-full mx-auto">
                        ...
                        <form action="${pageContext.request.contextPath}/register" method="post" class="space-y-5">
                            ...
                            <div class="space-y-3 pt-2">
                                <label class="flex items-start gap-3">
                                    <input name="agree" type="checkbox" required class="mt-1 w-5 h-5 text-primary" />
                                    <span class="text-sm">
                                ...
                                <label class="flex items-start gap-3">
                                    <input name="subscribe" type="checkbox" class="mt-1 w-5 h-5 text-primary" />
                                    <span class="text-sm">
                        ...
                        <div class="mt-8 text-center">
                            <p class="text-slate-500 dark:text-slate-400">
                                ...
                                <a href="${pageContext.request.contextPath}/views/custumer/auth/login.jsp"
