<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>Quên Mật Khẩu - Maison D'Or</title>
                ...
                <div class="relative z-10 w-full max-w-md">
                    <div class="bg-surface-dark border border-[#37342a] shadow-2xl gold-glow rounded-xl p-8 md:p-12">
                        <div class="text-center mb-8">
                            ...
                            <h3 class="text-2xl md:text-3xl font-serif font-bold gold-gradient-text mb-2">Quên Mật Khẩu
                            </h3>
                            <p class="text-slate-400 text-sm">Nhập email đã đăng ký để nhận link đặt lại mật khẩu</p>
                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            <input
                                                ...
                                                id="email" name="email" placeholder="nhap-email@example.com"
                                                type="email" required />
                                        </div>
                                    </div>
                                    <button
